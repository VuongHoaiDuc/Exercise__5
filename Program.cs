...
class Program
{
    static void Main(string[] args)
    {
        ...
        Quanlichuyenxe trip1 = new Chuyenxenoithanh("CX001", "Nguyễn Hoài An", "59A-54321", 1000000, "Tuyen 1", 50);
        Quanlichuyenxe trip2 = new Chuyenxenoithanh("CX002", "Dương Hữu Nhân", "59B-56789", 1500000, "Tuyen 2", 60);
        //Create 2 object of Chuyenxengoaithanh class
        Quanlichuyenxe trip3 = new Chuyenxengoaithanh("CX003", "Trần Thị Yến Nhi", "59C-54321", 2000000, "TP HCM", 5);
        Quanlichuyenxe trip4 = new Chuyenxengoaithanh("CX004", "Tăng Thị Đức Đạt", "59D-98765", 2500000, "Ha Noi", 10);
